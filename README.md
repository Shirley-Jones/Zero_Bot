# Zero_Bot by Shirley!
#### WoW1.12.1与TurtleWoW的厄运之槌地下城机器人|WoW1.12.1 and TurtleWoW's Dire Maul Dungeon Robot
* 厄运东法师刷花 - 功能列表
* 1、无人值守自动化： 支持掉线自动重连、自动登录与死亡自动跑尸。
* 2、支持无限多开、自动邮寄、自动清包、自动跑尸、自动登录、掉线自动重连、物品白名单、邮寄白名单、不依赖任何插件，只读内存和CALL函数操作、不改内存、不飞天、不瞬移、自动清零机器人行为MovementAnticheat Total计数器。
* 3、自动售卖和邮寄： 配备物品白名单过滤、自动贩卖清包及全自动邮寄功能，背包永不爆仓。
* 4、资源多开支持： 深度优化资源占用，支持无限多开批量化稳定运行。
* 5、脚本目前只支持厄运东法师刷花(仅支持 法师-60级)
* 6、支持乌龟服、卡皮巴拉、原版1.12.1、其他服不支持
* 7、支持全自动钓鱼
#### 
...
* 7. Supports fully automated fishing.
#### 
...
* Be sure to check the "Instructions for Use," otherwise you might encounter all sorts of strange issues.
* Start Enjoy!
